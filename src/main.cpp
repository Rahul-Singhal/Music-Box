...
static int fps=100;
static int numFrames = 25;
static int timeFrame=60;
...
static int SCREEN_WIDTH=640, SCREEN_HEIGHT=360;
...
void capture_frame(unsigned int framenum)
{
    ...
    char filename[200];
    sprintf(filename,"dump/frame_%04d.ppm",framenum);
